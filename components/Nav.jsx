...
const Nav = () => {
  ...
  <div className='text-white'>
        <div className='flex bg-blue items-center px-4 py-3 gap-4 '>
            <ImSearch size={25} className=''/>
            <input type='search' placeholder='Search' name='search' className='bg-blue focus:outline-none '/>
        </div>
      <div className='bg-black'>
        ...
        <div className='flex flex-col gap-3 py-4'>
          ...
          <div className='flex flex-col items-center   w-[60%] mx-auto'>
            ...
            <input name='email' placeholder='Enter your Email' className='bg-blue focus:outline-none border-b-[1px] border-b-terms w-[90%]'/>
            <IoChevronForwardSharp size={30} className='w-[10%]'/>
            </div>
